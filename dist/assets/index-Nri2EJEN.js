  ...
  `}function m(){return`
    <section class="panel">
      ...
      <div class="course-grid">
        ${n.courses.map(e=>`
              <article class="course-card ${e.color}">
                <div class="course-badge">${e.category}</div>
                <h4>${e.title}</h4>
                <div class="course-meta">
                  <span>${e.lessons} lessons</span>
                ...
                <div class="mentor-row">
                  <div class="avatar">${e.mentor.charAt(0)}</div>
                  <span>${e.mentor}</span>
                </div>
              </article>
            `).join("")}
